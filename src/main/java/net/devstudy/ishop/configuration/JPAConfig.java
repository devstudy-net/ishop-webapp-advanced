...
import net.devstudy.ishop.repository.SearchProductRepositoryImpl;
...
@EnableJpaRepositories(value="net.devstudy.ishop.repository", repositoryBaseClass=SearchProductRepositoryImpl.class)
public class JPAConfig {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory(){
		...
		entityManagerFactory.setPackagesToScan("net.devstudy.ishop.entity");
